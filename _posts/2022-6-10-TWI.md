...
Please feel free to check out the deployed app here:
[https://share.streamlit.io/jpetersen626/tanzania-group-project/main/app-streamlit.py](https://share.streamlit.io/jpetersen626/tanzania-group-project/main/app-streamlit.py){:target="_blank"}


Also, please feel free to find more information and code behind the project on GitHub:
[https://github.com/sbfullerstudio/Tanzania_Waterpoint_Improvement](https://github.com/sbfullerstudio/Tanzania_Waterpoint_Improvement){:target="_blank"}
